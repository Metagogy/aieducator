...
export class DataServiceService {
  ...
  lastActivity(id:any,cat:any,course_slno:any,topic_slno:any){
      return this.http.post(this.url+'topic_lastactivity',{'id':id,'cat':cat,'course_slnno':course_slno,'topic_slno':topic_slno});
  }
  ...
  {
      // console.log("The course id in getGroupId is ",courseId)
