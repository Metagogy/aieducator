...
Highcharts.chart('activeCoursePS'+index, {
    ...
    series: [{
        ...
        name: "timetaken by " + arrayItem.final_assignment_data.user1.name,
        ...
        name: "timetaken by " + arrayItem.final_assignment_data.user2.name,
        color: 'rgba(126,86,134,.9)',
        ...
        name: "timetaken by "+arrayItem.final_assignment_data.user3.name,
        color: 'rgba(126,86,134,.9)',
        ...
        name: "timetaken by "+arrayItem.final_assignment_data.user4.name,
        color: 'rgba(126,86,134,.9)',
        ...
        name: "timetaken by "+arrayItem.final_assignment_data.user5.name,
        color: 'rgba(126,86,134,.9)',
